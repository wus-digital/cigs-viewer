...
export const fullscreenButtonClasses = `${buttonInteraction} pointer-events-auto grid h-[45px] w-[45px] flex-none place-items-center rounded-[3px] border border-white/50 bg-black/55 text-white enabled:hover:bg-black/45`;
